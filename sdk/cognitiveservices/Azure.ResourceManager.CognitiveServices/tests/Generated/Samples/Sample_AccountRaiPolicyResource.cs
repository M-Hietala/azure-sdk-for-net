...
{
    public partial class Sample_AccountRaiPolicyResource
    {
        [Test]
        ...
        public async Task Get_GetRaiPolicy()
        {
            ...
            // this example assumes you already have this AccountRaiPolicyResource created on azure
            // for more information of creating AccountRaiPolicyResource, please refer to the document of AccountRaiPolicyResource
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            string resourceGroupName = "resourceGroupName";
            string accountName = "accountName";
            string raiPolicyName = "raiPolicyName";
            ResourceIdentifier accountRaiPolicyResourceId = AccountRaiPolicyResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, accountName, raiPolicyName);
            AccountRaiPolicyResource accountRaiPolicy = client.GetAccountRaiPolicyResource(accountRaiPolicyResourceId);

            // invoke the operation
            AccountRaiPolicyResource result = await accountRaiPolicy.GetAsync();
        ...
        public async Task Delete_DeleteRaiPolicy()
        {
            ...
            // invoke the operation
            await accountRaiPolicy.DeleteAsync(WaitUntil.Completed);
...
Source = RaiPolicyContentSource.Prompt,
            ...
            ArmOperation<AccountRaiPolicyResource> lro = await accountRaiPolicy.UpdateAsync(WaitUntil.Completed, data);
            AccountRaiPolicyResource result = lro.Value;
