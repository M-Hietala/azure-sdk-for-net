...
{
    public partial class Sample_AccountRaiPolicyCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_PutRaiPolicy()
        {
            ...
            // get the collection of this AccountRaiPolicyResource
            AccountRaiPolicyCollection collection = cognitiveServicesAccount.GetAccountRaiPolicies();
...
Source = RaiPolicyContentSource.Prompt,
            ...
            ArmOperation<AccountRaiPolicyResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, raiPolicyName, data);
        ...
        public async Task Get_GetRaiPolicy()
        {
            ...
            // invoke the operation
            string raiPolicyName = "raiPolicyName";
            AccountRaiPolicyResource result = await collection.GetAsync(raiPolicyName);
        ...
        public async Task GetAll_ListRaiPolicies()
        {
            ...
            await foreach (AccountRaiPolicyResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_GetRaiPolicy()
        {
            ...
            // invoke the operation
            string raiPolicyName = "raiPolicyName";
            NullableResponse<AccountRaiPolicyResource> response = await collection.GetIfExistsAsync(raiPolicyName);
            AccountRaiPolicyResource result = response.HasValue ? response.Value : null;
