...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class ManagedNetworkProvisionStatus
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedNetworkProvisionStatus"/>. </summary>
        /// <param name="networkStatus"> Status for the managed network of a cognitive services account. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal ManagedNetworkProvisionStatus(ManagedNetworkStatus? networkStatus, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        [WirePath("status")]
        public ManagedNetworkStatus? NetworkStatus { get; set; }
    }
}
