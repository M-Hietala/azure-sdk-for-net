...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class AgenticApplication : CognitiveServicesResourceBase
    {
        /// <summary> Initializes a new instance of <see cref="AgenticApplication"/>. </summary>
        ...
        internal AgenticApplication(string description, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, string displayName, Uri baseUri, IList<AgentReference> agents, AssignedIdentity agentIdentityBlueprint, AssignedIdentity defaultInstanceIdentity, ApplicationAuthorizationPolicy authorizationPolicy, ApplicationTrafficRoutingPolicy trafficRoutingPolicy, AgenticApplicationProvisioningState? provisioningState, bool? isEnabled) : base(description, tags, serializedAdditionalRawData)
        {
        ...
        [WirePath("agents")]
        public IList<AgentReference> Agents { get; set; }
